export default [
  {
    ...
    description: 'In his first major solo exhibition in London, NEW FICTION, KAWS (Brian Donnelly b.1974) presents new and recent works in physical and augmented reality at Serpentine North from 18 January - 27 February 2022. The exhibition is presented in collaboration with Acute Art and curated by Acute Art\'s Artistic Director, Daniel Birnbaum. A parallel digital version of the show launches simultaneously in Fortnite, a video game developed by Epic Games.', //String
  ...
  {
    title: 'Test', //String
    typeOfPlace: 'Test', //String
    description: 'TestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTestTest', //String
    imageUrl: 'Test', //String
    status: true, //Boolean
    tags: ['Test'], //Array of strings
    latitude: 1, //Number
    longitude: 1, //Number
  },
  {
    title: 'Waterlook bridge - Great view of London Thames sites', //String
  ...
  },
  {
    ...
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9tCfMCdQ1vSLbXKg455f4mEtX1MhaOKg7v5cuOkqXdAeN6663-Hb7QSmY7PTQbsMdZUE&usqp=CAU', //String
    status: true, //Boolean
    tags: [], //Array of strings
