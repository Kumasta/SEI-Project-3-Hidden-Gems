      ...
      {userData ?
        <Col>
          <Row>
            ...
            <Col>
              <h1>Profile Stats</h1>
              <h3>No. of pins added: <span>{userData.ownedPins.length ? userData.ownedPins.length : 0}</span></h3>
              <h3>Total Average Pin Rating: <span>{userAvgPinRating ? userAvgPinRating.toFixed(2) : 'No ratings'}</span></h3>
              <h3>Member Since: <span>{userData.createdAt.slice(0, 10)}</span></h3>
